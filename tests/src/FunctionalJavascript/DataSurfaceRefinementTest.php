 ...
 * does not drag the host form into validation: the region is still
 * unchosen and required while the chain runs, and no error is raised —
 * the surface's AJAX is scoped to the surface's own container.
 *
